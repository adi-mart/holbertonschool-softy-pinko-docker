...
Ce dossier contient la solution Dockerisée de l'application Softy Pinko, composée d'un back-end (API Flask) et d'un front-end statique (servi par Nginx).
...
## Détails
Consultez les README dans `back-end/` et `front-end/` pour plus d'informations sur chaque service.
