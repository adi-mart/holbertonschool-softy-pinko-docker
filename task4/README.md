...
Ce dossier contient la solution Dockerisée de l'application Softy Pinko, composée d'un back-end (API Flask avec flask-cors), d'un front-end statique (servi par Nginx) et d'une orchestration via docker-compose.
